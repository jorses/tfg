...
% Tutor
\def\directorPortadaVal{ Bel\'en D\'iaz Agudo, Juan Antonio Recio Garc\'ia}
...
\textit{Memoria que presenta para optar al t�tulo de Doctor en Inform�tica}  \\ [0.3em]%
...
\textit{Dirigida por los Doctores}  \\ [0.3em]
...
\ifpdf
\pdfbookmark{P�gina de T�tulo}{titulo}
\fi
...
\textbf{Arquitectura y metodolog�a para el}}
\begin{center}
\rule{\longTitulo}{.5mm}\\
\vskip 1cm
