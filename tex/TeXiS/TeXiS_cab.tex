...
\newcommand{\NotasBibliograficas}{Bibliographic Notes\markright{Bibliographic Notes}}
\newcommand{\TocNotasBibliograficas}{\addcontentsline{toc}{section}{Bibliographic Notes}}
